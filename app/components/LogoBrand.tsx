...
export default function LogoBrand({ className = "", compact = false }: LogoBrandProps) {
  return (
    <Link
      href="/"
      className={`flex min-w-0 max-w-[calc(100%-3rem)] items-center gap-2 rounded-xl border border-gold/40 bg-black/40 px-2 py-1.5 backdrop-blur-md sm:gap-3 sm:px-3 sm:py-2 ${className}`}
    >
